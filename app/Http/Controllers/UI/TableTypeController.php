...
class TableTypeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('users.tableTypes.index',compact('tableTypes'));
    }
    ...
    {
        return view ('users.tableTypes.create-edit');
    }
    ...
    public function store(Request $request)
    {
        ...
        $tableType->save();
        return redirect('user/tableType');
    }
    ...
    public function edit($id)
    {
        ...
        return view('users.tableTypes.create-edit',compact('tableType'));
    }

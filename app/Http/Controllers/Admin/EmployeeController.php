...
class EmployeeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admins.employees.index',compact('employees'));
    }
    ...
    {  
        ...
        return view ('admins.employees.create-edit',compact('employeeTypes','genders','canteenInfos'));
    }
    ...
    public function edit($id)
    {
        ...
        $genders=Gender::all();
        $canteenInfos=CanteenInfo::all();
        return view('admins.employees.create-edit',compact('employee','genders','canteenInfos','employeeTypes'));
    }

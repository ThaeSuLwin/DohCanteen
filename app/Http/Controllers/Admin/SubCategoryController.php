...
use App\{SubCategory,Category,Option,SubCategoryOption,CanteenInfo,Addition,SubCategoryAddition};
use Str;
use Image;
...
class SubCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admins.subCategories.index',compact('subCategories'));
    }
    ...
    public function create()
    {
        ...
        return view('admins.subCategories.create-edit',compact('categories','options','additions','canteenInfos'));
    }
    ...
    public function edit($id)
    {
        ...
        $options=Option::all();
        $additions=Addition::all();
        return view('admins.subCategories.create-edit',compact('categories','subCategory','options','additions','canteenInfos'));
    ...
    public function update(Request $request, $id)
    {
       ...
       if($request->image){
        ...
        $subCategory->additions()->sync($request->addition);
        return redirect('admin/subCategory');
    }

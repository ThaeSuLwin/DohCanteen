        ...
        <div class="col-md-12">
            <div class="card">
                 <div class="card-title" style="background-color:rgb(31, 49, 153);">
                    <div class=" mt-4  pl-4"><h3  style="color: white; font-weight:bold">User Edit Form</h3>
                  </div>
                </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{url('admin/user/update/'.$user->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" placeholder="Enter user name" class="form-control border border-primary @error('name') is-invalid @enderror" name="name" value="{{ $user->name }}" required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" placeholder="Enter user email" type="email" class="form-control border border-primary @error('email') is-invalid @enderror" name="email" value="{{ $user->email }}" required autocomplete="email">

                    ...
                    <div class="col-lg-10 offset-lg-1">
                        ...
                        <article class="post post-wide animated" data-animation="fadeIn">
                            <div class="post-image">
                                {{--<img src="http://assets.suelo.pl/soup/img/posts/post01.jpg" alt="">--}}
                                <img src="{{asset('storage/canteen_info_images/'.$canteenInfo->image)}}" alt="image">
                                </div>
                            <div class="post-content">
                                ...
                                <h4><a href="blog-post.html">{{$canteenInfo->name}}</a></h4>
                               
                                <p>
                                    @foreach(explode(',',$canteenInfo->description) as $info)
                                    <h6> {{$info}} </h6>
                                    @endforeach
                                </p>
                                   <div class="col-md-6">
                                <a href="{{ url('user/canteenInfo/'.$canteenInfo->id)}}"><button class="btn btn-success  btn-sm">Menu</button></a>
                                </div> 
                            </div>
                        </article>
                        @endforeach
